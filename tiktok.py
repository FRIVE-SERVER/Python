...
def bongoc(so):
        for i in range(so):
                Write.Print('────',Colors.green_to_cyan,interval=0.0001, end = '')
                #print(red+'────', end = '' )
        Write.Print('',Colors.green_to_cyan,interval=0.0001,end = '\n')
        #print('')
        ...
        def nhan_xu(self, id, type):
                try:
                        ...
                        try:
                                ...
                                total+=xuthem
                                bongoc(14)
                                Write.Print(f'Nhận Thành Công {job} Nhiệm Vụ | {msg} | TOTAL {total} Xu | {xu} \n',Colors.green_to_red,interval=0.0001)
                                ...
                                if '"code":"error","msg"' in nhan.text:
                                        ...
                                        Write.Print('Nhận Xu Thất Bại !!!',Colors.green_to_red,interval=0.0001,end='\r'); sleep(2); print('                                                       ', end = '\r')
...
def delay(dl):
  try:
    for i in range(dl, -1, -1):
       Write.Print(f'[FRIVE-TOOL][{i}]           ',Colors.green_to_red,interval=0.0001,end='\r')
       #print(f'{vang}[{trang}FRIVE-TOOL{vang}][{trang}'+str(i)+vang+']           ',end='\r')
       sleep(1)
  except:
     sleep(dl)
     Write.Print(dl,Colors.green_to_red,interval=0.0001,end='\r')
     #print(dl,end='\r')
...
def main():
        ...
        while True:
                if os.path.exists('configtds.txt'):
                        ...
                        data = tds.main()
                        try:
                                Write.Print(f'{thanh_xau}Nhập [1] Giữ Lại Tài Khoản  data[{user}] \n',Colors.green_to_red,interval=0.0001)
                                #print(f'{thanh_xau}{luc}Nhập {vang}[{trang}1{vang}] {luc}Giữ Lại Tài Khoản '+vang+ data['user'] )
                                Write.Print(f'{thanh_xau}Nhập [2] Nhập Access_Token TDS Mới\n',Colors.green_to_red,interval=0.0001)
                                ...
                                if chon == '2':
                                        ...
                                        Write.Print('Lựa chọn không xác định !!!\n',Colors.green_to_red,interval=0.0001);bongoc(14)
                                        #print(red+'Lựa chọn không xác định !!!');bongoc(14)
                                        continue 
                        except:
                                os.remove('configtds.txt')
                if not os.path.exists('configtds.txt'):
                        token = Write.Input(f'{thanh_xau}Nhập Access_Token TDS: ',Colors.green_to_cyan,interval=0.0001)
...
#while True:
        ...
        banner()
        Write.Print(f'{thanh_xau}Tên Tài Khoản: {user} \n',Colors.green_to_red,interval=0.0001)
        #print(f'{thanh_xau}{luc}Tên Tài Khoản: {vang}{user} ')
        Write.Print(f'{thanh_xau}Xu Hiện Tại: {xu}\n',Colors.green_to_red,interval=0.0001)
        #print(f'{thanh_xau}{luc}Xu Hiện Tại: {vang}{xu}')
        Write.Print(f'{thanh_xau}Xu Bị Phạt: {xudie} \n',Colors.green_to_red,interval=0.0001)
        #print(f'{thanh_xau}{luc}Xu Bị Phạt: {vang}{xudie} ')
        while True:
                ntool=0
                bongoc(14)
                Write.Print(f'{thanh_xau}Nhập [1] Để Chạy Nhiệm Vụ Tim\n',Colors.green_to_red,interval=0.0001)
                #print(f'{thanh_xau}{luc}Nhập {red}[{vang}1{red}] {luc}Để Chạy Nhiệm Vụ Tim')
                Write.Print(f'{thanh_xau}Nhập [2] Để Chạy Nhiệm Vụ Follow\n',Colors.green_to_red,interval=0.0001)
                #print(f'{thanh_xau}{luc}Nhập {red}[{vang}2{red}] {luc}Để Chạy Nhiệm Vụ Follow')
                Write.Print(f'{thanh_xau}Nhập [3] Để Chạy Nhiệm Vụ Follow Tiktok Now\n',Colors.green_to_red,interval=0.0001)
                #print(f'{thanh_xau}{luc}Nhập {red}[{vang}3{red}] {luc}Để Chạy Nhiệm Vụ Follow Tiktok Now')
                nhiem_vu = Write.Input(f'{thanh_xau}Nhập Số Để Chạy Nhiệm Vụ: ',Colors.green_to_cyan,interval=0.0001)
                #nhiem_vu=input(f'{thanh_xau}{luc}Nhập Số Để Chạy Nhiệm Vụ: {vang}')
                dl = int(Write.Input(f'{thanh_xau}Nhập Delay: ',Colors.green_to_cyan,interval=0.0001))
                ...
                while True:
                        ...
                        ntool = 0
                        bongoc(14)
                        nv_nhan = int(Write.Input(f'{thanh_xau}Sau Bao Nhiêu Nhiệm Vụ Thì Nhận Xu: ',Colors.green_to_cyan,interval=0.0001))
                        #nv_nhan=int(input(f'{thanh_xau}{luc}Sau Bao Nhiêu Nhiệm Vụ Thì Nhận Xu: {vang}'))
                        if nv_nhan < 8:
                                Write.Print('Trên 8 Nhiệm Vụ Mới Được Nhận Tiền!\n',Colors.green_to_red,interval=0.0001)
                                #print(red+'Trên 8 Nhiệm Vụ Mới Được Nhận Tiền!')
                                continue
                        if nv_nhan > 15:
                                Write.Print('Nhận Xu Dưới 15 Nhiệm Vụ Để Tránh Lỗi\n',Colors.green_to_red,interval=0.0001)
                                #print(red+'Nhận Xu Dưới 15 Nhiệm Vụ Để Tránh Lỗi')
                                continue
                        user_cau_hinh = Write.Input(f'{thanh_xau}Nhập User Name Tik Tok Cần Cấu Hình: ',Colors.green_to_cyan,interval=0.0001)
                                ...
                                if '1' in nhiem_vu:
                                        ...
                                        if listlike == False:
                                                ...
                                                if listlike.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
                                                        ...
                                                        Write.Print(f'Đang Get Nhiệm Vụ Like, COUNTDOWN: {str(round(coun, 3))} \n',Colors.green_to_yellow,interval=0.0001, end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                                        ...
                                                        Write.Print(listlike.json()['error'],Colors.green_to_cyan,interval=0.0001, end ='\r');sleep(2); print('                                                        ', end = '\r')
                                                ...
                                                if len(listlike) == 0:
                                                        ...
                                                        Write.Print(f'Tìm Thấy {len(listlike)} Nhiệm Vụ Like                       ',Colors.green_to_cyan,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
                                                        ...
                                                        for i in listlike:
                                                                ...
                                                                if cache != True:
                                                                        ...
                                                                        if dem % nv_nhan == 0:
                                                                                ...
                                                                                if nhan == 0:
                                                                                        Write.Print('Nhận Xu Thất Bại Acc Tiktok Của Bạn Ổn Chứ \n',Colors.green_to_red,interval=0.0001, end = '\r')
                                                                                        #print(luc+'Nhận Xu Thất Bại Acc Tiktok Của Bạn Ổn Chứ ') 
                                                                                        Write.Print(f'{thanh_xau}Nhập [1] Để Thay Nhiệm Vụ \n',Colors.green_to_yellow,interval=0.0001, end = '\r')
                                                                                        #print(f'{thanh_xau}{luc}Nhập {red}[{vang}1{red}] {luc}Để Thay Nhiệm Vụ ')
                                                                                        Write.Print(f'{thanh_xau}Nhập [2] Thay Acc Tiktok \n',Colors.green_to_yellow,interval=0.0001, end = '\r')
                                                                                        #print(f'{thanh_xau}{luc}Nhập {red}[{vang}2{red}] {luc}Thay Acc Tiktok ')
                                                                                        Write.Print(f'{thanh_xau}Nhấn [Enter] Để Tiếp Tục\n',Colors.green_to_yellow,interval=0.0001, end = '\r')
                                                                                        #print(f'{thanh_xau}{luc}Nhấn {red}[{vang}Enter{red}] {luc}Để Tiếp Tục')
                                                                                        chon = Write.Input(f'{thanh_xau}Nhập : ',Colors.green_to_cyan,interval=0.0001)
                                                                                        #chon=input(f'{thanh_xau}{luc}Nhập {trang}: {vang}')
                                                                                        if chon == '1':
                                                                                                ntool=2
                                                                                                break
                                ...
                                if '2' in nhiem_vu:
                                        ...
                                        if listfollow == False:
                                                ...
                                                if listfollow.json()['error'] == 'Thao tác quá nhanh vui lòng chậm lại':
                                                        ...
                                                        Write.Print(f'Đang Get Nhiệm Vụ Follow, COUNTDOWN: {str(round(coun, 3))} \n',Colors.green_to_yellow,interval=0.0001, end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                                        ...
                                                        Write.Print(listfollow.json()['error'],Colors.green_to_cyan,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
                                                        #print(red+listfollow.json()['error'] , end ='\r');sleep(2); print('                                                        ', end = '\r')
                                        else:
                                                try:
                                                        listfollow = listfollow.json()['data']
                                                except:
                                                        Write.Print('Hết Nhiệm Vụ Follow                             ',Colors.green_to_red,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
                                                ...
                                                if len(listfollow) == 0:
                                                        ...
                                                        Write.Print(f'Tìm Thấy {len(listfollow)} Nhiệm Vụ Follow                       ',Colors.green_to_cyan,interval=0.0001, end = '\r');sleep(2); print('                                                        ', end = '\r')
                                        ...
                                        if listfollow == False:
                                                ...
                                                if len(listfollow) == 0:
                                                        ...
                                                        for i in listfollow:
                                                                ...
                                                                if cache != True:
                                                                        tg=datetime.now().strftime('%H:%M:%S')
                                                                        Write.Print(f'[X] | {tg} | FOLLOW_NOW | {id} |\n',Colors.green_to_red,interval=0.0001, end = '\r');sleep(1); print('                                                                                        ', end = '\r')
                                                                        #hien = f'{vang}[{red}X{vang}] {red}| {lam}{tg} {red}| {vang}FOLLOW_NOW {red}| {trang}{id} {red}|'; print(hien, end = '\r');sleep(1); print('                                                                                        ', end = '\r')
                                                                else:
                                                                        dem+=1
                                                                        tg=datetime.now().strftime('%H:%M:%S')
                                                                        Write.Print(f'[{dem}] | {tg} | FOLLOW_NOW | {id} |\n',Colors.green_to_red,interval=0.0001, end = '\r')
