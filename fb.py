...
def error(id, type):
	time=datetime.now().strftime("%H:%M:%S")
	uid = id.split('_')[1] if '_' in id else id
	print(f'', end = '\r'); sleep(2); print('                                                   ', end = '\r')
...
def Nhap_Cookie():
	...
	while True:
		i += 1
		cookie = input(f'\033[1;32mNhập Cookie Facebook Thứ: \033[1;33m{i}: ')
		if cookie == '' and i > 1:
			break
...
def main():
	...
	dem = 0
	while True:
		if os.path.exists('tds.txt'):
			with open('tds.txt', 'r') as f:
				token = f.read()
			tds = TraoDoiSub_Api(token)
			data = tds.main()
			try:
				print('\033[1;32mNhập [\033[1;33m1\033[1;32m] Giữ Lại Tài Khoản '+ data['user'] )
				print('\033[1;32mNhập [\033[1;33m2\033[1;32m] Nhập Access_Token TDS Mới')
				chon = input('\033[1;32mNhập:\033[1;33m ')
				if chon == '2':
					os.remove('tds.txt')
				elif chon == '1':
					pass
				...
				os.remove('tds.txt')
		if not os.path.exists('tds.txt'):
			token = input('\033[1;32mNhập Access_Token TDS:\033[1;33m ')
	...
	while True:
		if os.path.exists('Cookie_FB.txt'):
			print('\033[1;32mNhập [\033[1;33m1\033[1;32m] Sử Dụng Cookie Facebook Đã Lưu ')
			print('\033[1;32mNhập [\033[1;33m2\033[1;32m] Nhập Cookie Facebook Mới')
			chon = input('\033[1;32mVui Lòng Nhập:\033[1;33m ')
			if chon == '1':
		...
		if not os.path.exists('Cookie_FB.txt'):
			...
			break
	print(f'\033[1;32mTên Tài Khoản: {user} ')
	print(f'\033[1;32mXu Hiện Tại: {xu}')
	print(f'\033[1;32mXu Bị Phạt: {xudie} ')
	print(f'\033[1;32mSố Cookie: {len(list_cookie)} ')

	print('\033[1;31m────────────────────────────────────────────────────────────')
	print('NHẬP \033[1;32m[''1''] CHẠY JOB LIKE')
	print('NHẬP \033[1;32m[''2''] CHẠY JOB CMT')
	print('NHẬP \033[1;32m[''3''] CHẠY JOB SHARE')
	print('NHẬP \033[1;32m[''4''] CHẠY JOB CẢM XÚC')
	print('NHẬP \033[1;32m[''5''] CHẠY JOB FOLLOW')
	print('NHẬP \033[1;32m[''6''] CHẠY JOB LIKE PAGE')
	print('NHẬP \033[1;32m[''7''] CHẠY JOB CẢM XÚC CMT')
	print('NHẬP \033[1;32m[''8''] CHẠY JOB JOIN GROUP ')
	print('\033[1;31m────────────────────────────────────────────────────────────')

	print('\033[1;32mCó Thể Chọn Nhiều Nhiệm Vụ (Ví Dụ 123...)')
	nhiemvu = input ('\033[1;32mNhập Số Để Chạy Nhiệm Vụ: ')
	delaymin = int(input('\033[1;32mNhập Delay Min: '))
	delaymax = int(input('\033[1;32mNhập Delay Max: '))
	print('\033[1;32mSau ____ Nhiệm Vụ Thì Kích Hoạt Chống Block.',end='\r')
	nvblock = int(input('\033[1;32mSau '))
	print(f'\033[1;32mSau {nvblock} Nhiệm Vụ Nghỉ Ngơi ____ Giây       ',end='\r')
	delaybl = int(input(f'\033[1;32mSau {nvblock} Nhiệm Vụ Nghỉ Ngơi '))
	doinick = int(input('\033[1;32mSau Bao Nhiêu Nhiệm Vụ Thì Đổi Nick: '))
	print('\033[1;31m────────────────────────────────────────────────────────────')
	while True:
